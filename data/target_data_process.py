...
# 获得所有没有报道过跟肝癌有关的靶标 及其推荐的药物
    ...
    for target in un_relevant_targets:
        drug_a_not_relevant, drug_c_not_relevant, drug_not_relevant, drug_frequency = [], [], [], []
        drug_phase, drug_ap_cl, drug_ap, drug_cl = [], [], [], []
        ...
        try:
            ...
            # 打印报错的具体原因
            print(target, traceback.format_exc())
            print(target + '这个靶标所有药物都报道过肝癌')


'''
使用pycharts绘制靶标推荐药物的Sunburst图
...
c = (
    ...
    # .set_global_opts(title_opts=opts.TitleOpts(title="推荐药物"))
